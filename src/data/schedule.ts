...
export const schedule:Talk[] = [
  ...
  {
    time: 'Hora por confirmar',
    title: 'Desde Hogwarts a la Banca: Una Historia de Magia en la Ciencia de Datos.',
    description: 'Exploraremos los desafíos que demanda tu primera experiencia laboral cuando tienes un  perfil en humanidades y quieres sumergirte en el ámbito tecnológico. Además, hablaremos sobre las exigencias que la industria financiera impone a los científicos de datos.',
    speaker: Speakers.speakerDenisse,
  },
];
